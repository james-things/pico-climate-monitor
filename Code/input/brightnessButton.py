...
class DesiredBrightnessButton:
    ...
    # Initializaton
    def __init__(self, pin_number, lcd_display_controller, use_pullups=False, initial_brightness=50):
